        ...
        if "Track" in abstract:
            ...
            for track_info in tracks_infos:
                ...
                with open(os.path.join('tmpopen', sig_file_path), 'rb') as h:
                    ...
                    LSB=(adc_range / (2^adc_nbits)* gain)*unit_of_measurement_factor;
    ...
    if(os.path.exists(commonFilesPath)):
        ...
        if(len(file_names)>0):
            ...
            for file_name in file_names:
                ...
                tracks.append(otbClasses.Track(sections, frequency, number_of_channels,unit_of_measure=unit_of_measure,title=title))
